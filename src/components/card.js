...
export class Card extends CardComponent {
  ...
  constructor({id, description, dueDate, tags, color, repeatingDays, dateSwitch, repeatSwitch}) {
    super({id, description, dueDate, tags, color, repeatingDays, dateSwitch, repeatSwitch});
    this.id = id;
